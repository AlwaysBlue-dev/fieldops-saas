...
export const whatIsFieldkeel: DocArticle = {
  slug: "what-is-fieldkeel",
  title: "What is FieldKeel?",
  description:
    "FieldKeel is an operations command center for field-service companies — office staff plan and approve work; technicians run the day from a phone-first shell.",
  ...
  sections: [
    {
      ...
      paragraphs: [
        "FieldKeel is built for electrical, HVAC, plumbing, fire/security, maintenance, and facilities contractors who need one organization workspace where office staff can plan, dispatch, and approve work, and field technicians can see their day, capture evidence, and account for the hours they actually worked.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Commercial access is organization-scoped. New workspaces start on a 14-day Professional trial with no card required, then a short grace period before the workspace becomes read-only until FieldKeel activates a paid plan by manual invoice.",
      ],
    },
    {
      id: "not-included",
      ...
      paragraphs: [
        "FieldKeel documentation does not claim SOC 2, ISO, or HIPAA certification. Security practices described elsewhere (HTTP-only session cookies, tenant isolation, private object storage) are product design choices — not third-party compliance attestations.",
      ],
    },
  ],
};
